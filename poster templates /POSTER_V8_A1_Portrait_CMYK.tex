...
% ===================== COLOUR PALETTE — warm academic (CMYK) =====================
\definecolor{parchment}{cmyk}{0.00, 0.01, 0.03, 0.01}
\definecolor{hdr}{cmyk}{0.32, 0.37, 0.00, 0.78}
\definecolor{terra}{cmyk}{0.00, 0.63, 0.73, 0.30}
\definecolor{sage}{cmyk}{0.37, 0.00, 0.14, 0.55}
\definecolor{warmamber}{cmyk}{0.00, 0.28, 0.89, 0.24}
\definecolor{ink}{cmyk}{0.17, 0.22, 0.00, 0.86}
\definecolor{stone}{cmyk}{0.00, 0.00, 0.00, 1.00}
\definecolor{rule}{cmyk}{0.00, 0.02, 0.07, 0.18}
\definecolor{cnnc}{cmyk}{0.59, 0.36, 0.00, 0.45}
\definecolor{vitc}{cmyk}{0.00, 0.63, 0.73, 0.30}
\definecolor{hybc}{cmyk}{0.54, 0.00, 0.12, 0.49}
\definecolor{txtc}{cmyk}{0.12, 0.58, 0.00, 0.42}
\definecolor{dqnc}{cmyk}{0.59, 0.36, 0.00, 0.45}
\definecolor{c51c}{cmyk}{0.00, 0.63, 0.73, 0.30}
\definecolor{ppoc}{cmyk}{0.54, 0.00, 0.12, 0.49}
\definecolor{cnntint}{cmyk}{0.07, 0.04, 0.00, 0.01}
\definecolor{c51tint}{cmyk}{0.00, 0.06, 0.07, 0.01}
\definecolor{hybtint}{cmyk}{0.05, 0.00, 0.02, 0.02}
